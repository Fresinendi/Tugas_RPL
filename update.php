  ...
  if(!empty($name)){
   ...
   if(!empty($image)){
      if($image_size > 2000000){
         ...
         $message[] = 'image berhasil di update';
      }
   }
...
<section class="form-container" style="min-height: calc(100vh - 19rem);">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="col">
               <p>pass lama</p>
               <input type="password" name="old_pass" placeholder="password lama..." maxlength="50" class="box">
               <p>pass baru</p>
               <input type="password" name="new_pass" placeholder="password baru..." maxlength="50" class="box">
               <p>konfir pass</p>
               <input type="password" name="cpass" placeholder="password baru..." maxlength="50" class="box">
         </div>
      </div>
